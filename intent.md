...
* **Base height**: `Pad.Length`=50mm (unbound literal) is the base block height — confirm the
  intended value so it can be promoted to a real Params variable (proposed name:
  `BaseHeight`, per `plan.md`).
